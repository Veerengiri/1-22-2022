...
function App() {
  ...
  return (
    <>
      <Router>
        <Routes>
          <Route path="/signIn" element={<ArtistSignIn backend={backend} setIslogin={setIslogin} setUserId={setUserId} />} />
          ...
          <Route
            ...
            element={
              <div id="art-site">
                <Menu islogin = {islogin} setIslogin={setIslogin}/>
                  <ProgressCheck backend={backend} islogin={islogin} userId={userId} setRegId={setRegId}/>
                <Footer />
              </div>
            }
          />
          ...
          <Route
            ...
            element={
              <div id="art-site">
                <Menu islogin = {islogin} setIslogin={setIslogin}/>
                <Events backend={backend} islogin={islogin} setEventId={setEventId}/>
                <Footer />
              </div>
            }
          />
          ...
          <Route
            ...
            element={
              <div id="art-site">
                <Menu islogin = {islogin} setIslogin={setIslogin}/>
                   <EventForm backend={backend} islogin={islogin} userId={userId} eventId={eventId} />
                <Footer />
              </div>
            }
          />

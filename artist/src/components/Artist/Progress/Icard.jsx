...
const Icard = (props) => {
  ...
  const getuserdt=async ()=>{
    ...
    switch (data.pg) {
      case 0:
          document.getElementById("r0").style.boxShadow = "0.5px 0.5px 5px 6px rgba(0, 128, 0, 0.4)"
          break;
      case 1:
          document.getElementById("p1").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r1").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r1").style.boxShadow = "0.5px 0.5px 5px 6px rgba(0, 128, 0, 0.4)"

          break;
      case 2:
          document.getElementById("p1").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r1").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("p2").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r2").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r2").style.boxShadow = "0.5px 0.5px 5px 6px rgba(0, 128, 0, 0.4)"
          break;
      case 3:
          document.getElementById("p1").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r1").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("p2").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r2").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("p3").style.backgroundColor = "rgb(1,240,1)"
          document.getElementById("r3").style.backgroundColor = "rgb(1,240,1)"

          document.getElementById("r3").style.boxShadow = "0.5px 0.5px 5px 6px rgba(0, 128, 0, 0.4)"
    ...
    <div >
      ...
      <div id='progress' className="progresscontener">
              <div className='progressbar'>
                  ...
                  <p>Id Status</p>
                  <div id='0'>
                      <div id='r0' className='roundfill' style={{ backgroundColor: "rgb(1,240,1)" }}></div>
                  ...
                  <button id='btn' className="btn" onClick={showId} style={{display:`${apr?"unset":"none"}`}}>Generate Id</button>
              </div>
          </div>
      </div>

        ...
        <form action="" className="contactus">
          ...
          <div className="input">
            ...
            >
              <div >{select}</div>
              <div  id="select">
                <div className="selectdiv" value="1" onClick={(e)=>{openfiled(1); setSelect("1")}}>1</div>
                <div className="selectdiv" value="2" onClick={(e)=>{openfiled(2); setSelect("2")}}>2</div>
                <div className="selectdiv" value="3" onClick={(e)=>{openfiled(3); setSelect("3")}}>3</div>
                <div className="selectdiv" value="4" onClick={(e)=>{openfiled(4); setSelect("4")}}>4</div>
                <div className="selectdiv" value="5" onClick={(e)=>{openfiled(5); setSelect("5")}}>5</div>
              </div>
            </div>
          </div>
